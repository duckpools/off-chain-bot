...
class HistoryMixin:
    ...
    def batch_upsert_user_lend_positions_historical(self, batch_data: List[Tuple]) -> int:
        """
        ...
        try:
            with self.get_connection() as conn:
                with conn.cursor() as cur:
                    ...
                    processed_data = []
                    for address, pool_nft, block_height, timestamp, position_tokens, position_value in batch_data:
