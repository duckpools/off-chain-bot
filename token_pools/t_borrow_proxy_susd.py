...
from helpers.platform_functions import get_dex_box, get_pool_param_box, get_interest_box, get_logic_box, get_parent_box, \
    get_head_child
from helpers.serializer import encode_long, encode_long_tuple, encode_int_tuple, encode_long_pair
            ...
            "requests": [
                ...
                },
                {
                    ...
                    "registers": {
                        ...
                        "R9": encode_long_tuple([aggregateThreshold, penalty, bufferGap, minimumValue, 0])
                    }
                },
                {
                    "address": tree_to_address(user_tree),
                ...
                },
                {
                    ...
                    "registers": {
                        "R4": encode_long_tuple([borrowLimit, liquidation_value, aggregateThreshold, penalty, minimumValue, bufferGap, 0]),
