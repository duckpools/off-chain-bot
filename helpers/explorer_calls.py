...
def get_unspent_boxes_by_token_id(token_id, limit=100, offset=0):
    return json.loads(get_request(f"{explorer_url}/boxes/unspent/byTokenId/{token_id}?limit={limit}&offset={offset}").text)['items']
